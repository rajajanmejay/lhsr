...
const galleryItems = [
  ...
  },
  {
    ...
    label:
      "Turbulent spot convection on a cone surface under Mach 5.85 freestream.",
    cat: CATEGORIES.RESEARCH,
  },
  {
  ...
  },
  {
    ...
    label:
      "Studies on Plate Specimen subjected to Friedlander Loading using DIC",
    cat: CATEGORIES.RESEARCH,
  },
  {
        ...
        <div className="gallery-grid">
          {filteredItems.map((g, idx) => (
            <div
              ...
              onClick={() => openModal(g.label, g.src)}
            >
              <img
                src={g.src}
                alt={g.label}
